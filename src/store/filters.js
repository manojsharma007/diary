...
export default {
  ...
  actions: {
    async getJournals({ commit }) {  
     return await axios.get(apiURL+"database.php")
     .then((response)=>{
    ...
    async addJournals({ commit }, params) {  
      return await axios.get(apiURL + "database.php?type=add&text=" + params.content+ "&time="+params.time)
      .then((response)=>{
        commit("setJournalsData", response);
      })
      .catch((error)=>{     
     ...
     async updateJournals({ commit }, params) {  
      return await axios.get(apiURL + "database.php?type=update&text=" + params.content+ "&id="+params.id)
      .then((response)=>{
        commit("setJournalsData", response);
      })
      .catch((error)=>{     
     ...
     return await axios.get(apiURL + "database.php?type=delete&id=" + params.id)
     .then((response)=>{
       commit("setJournalsData", response);
     })
     .catch((error)=>{     
